                  ...
                  <div class="dropdown-menu__body">
                    ...
                    <a href="{{ route('admin.notification.read',$notification->id) }}" class="dropdown-menu__item">
                      <div class="navbar-notifi">
                        ...
                        @elseif($notification->seller)
                        <div class="navbar-notifi__left bg--green b-radius--rounded"><img src="{{ getImage(imagePath()['seller']['profile']['path'].'/'.@$notification->seller->image,imagePath()['seller']['profile']['size'])}}" alt="@lang('Profile Image')"></div>
                        @endif
            ...
            <li class="dropdown">
                <button type="button" class="" data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false">
                  <span class="navbar-user">
                    <span class="navbar-user__thumb"><img src="{{ getImage('assets/dashboard/images/profile/'. auth()->guard('admin')->user()->image) }}" alt="image"></span>
