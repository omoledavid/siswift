...
<div class="row justify-content-center">
    @if(request()->routeIs('admin.withdrawals.log') || request()->routeIs('admin.withdrawals.method') || request()->routeIs('admin.users.withdrawals') || request()->routeIs('admin.users.withdrawals.method'))
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Seller')">
                                    <span class="font-weight-bold d-block">{{ $withdraw->seller->fullname }}</span>

                                    <span class="small"> <a href="{{ route('admin.sellers.detail', $withdraw->seller_id) }}"><span>@</span>{{ $withdraw->seller->username }}</a> </span>
                                </td>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{ route('admin.withdrawals.details', $withdraw->id) }}" class="icon-btn ml-1 " data-toggle="tooltip" data-original-title="@lang('Detail')">
...
@push('breadcrumb-plugins')
    ...
    <form action="{{ route('admin.withdrawals.search', $scope ?? str_replace('admin.withdraw.', '', request()->route()->getName())) }}" method="GET" class="form-inline float-sm-right bg--white mb-2 ml-0 ml-xl-2 ml-lg-0">
    ...
    <form action="{{route('admin.withdrawals.dateSearch',$scope ?? str_replace('admin.withdraw.', '', request()->route()->getName()))}}" method="GET" class="form-inline float-sm-right bg--white">
        <div class="input-group has_append">
