            ...
            <form action="{{ route('admin.gateway.automatic.update', $gateway->code) }}" method="POST"
                ...
                <div class="card-body">
                    <div class="payment-method-item">
                        <div class="payment-method-header justify-content-between">
                            <div class="thumb">
                            ...
                            <div class="">
                                <div class="form-group">
                                    <div class="input-group">
                                        <select class="newCurrencyVal form-control">
                        ...
                        <div class="payment-method-body mt-2">
                            ...
                            <div class="row">
                                @foreach($parameters->where('global', true) as $key => $param)
                                    <div class="form-group col-lg-6">
                                        <label class="font-weight-bold required">{{ __(@$param->title) }}</label>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                            <div class="card border--primary mt-2">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="font-weight-bold required">@lang('Minimum Amount')</label>
                                                        <div class="input-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="font-weight-bold required">@lang('Maximum Amount')</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text">{{ __($general->cur_sym) }}</div>
                                                            </div>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                            <div class="card border--primary mt-2">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="font-weight-bold required">@lang('Fixed Charge')</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="font-weight-bold required">@lang('Percent Charge')</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                            ...
                                            <div class="card border--primary mt-2">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="font-weight-bold">@lang('Symbol')</label>
                                                                <div class="input-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="font-weight-bold required">@lang('Rate')</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                            ...
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">
                                                                    <span class="currency_symbol">{{ __($gatewayCurrency->baseSymbol()) }}</span>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
