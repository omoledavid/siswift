...
@endpush
@push('style-lib')
    <link rel="stylesheet" href="{{asset('assets/dashboard/css/codemirror.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/dashboard/css/monokai.min.css')}}">
@endpush
@push('script-lib')
    <script src="{{asset('assets/dashboard/js/codemirror.min.js')}}"></script>
    <script src="{{asset('assets/dashboard/js/css.min.js')}}"></script>
    <script src="{{asset('assets/dashboard/js/sublime.min.js')}}"></script>
@endpush
@push('script')
<script>
    "use strict";
