                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <label class="form-control-label font-weight-bold" data-toggle="tooltip" title="@lang("Admin will get the commission from the sale of sellers' products.")"> @lang('Commission on Sale') </label>
                                <div class="form-group input-group">
                                    <input class="form-control form-control-lg" type="text" name="product_commission" value="{{$general->product_commission}}" required>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disable')" name="cod" @if($general->cod) checked @endif>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disable')" name="al" @if($general->al) checked @endif>
                                </div>
                            </div>
                        </div>
