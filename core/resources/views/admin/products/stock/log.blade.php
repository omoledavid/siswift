...
<a href="{{ route('admin.products.stock.create', $productStock->product->id) }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="las la-backward"></i>@lang('Go Back')</a>
@endpush
