                                    ...
                                    <div class="row mt-4 mb-none-15">
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                <label class="font-weight-bold required">@lang('Gateway Name')</label>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                <label class="font-weight-bold required">@lang('Currency')</label>
                                                <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group has_append">
                                                    ...
                                                    <div class="input-group-append">
                                                        <span class="input-group-text"><span class="currency_symbol"></span>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
