                                ...
                                <div class="content">
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group">
                                                <label class="required font-weight-bold">@lang('Currency')</label>
                                        ...
                                        <div class="col-xl-5 col-md-12">
                                            <label class="required font-weight-bold">@lang('Rate')</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label class="requred font-weight-bold">@lang('Fixed Charge')</label>
                                                ...
                                                <div class="form-group">
                                                    <label class="requred font-weight-bold">@lang('Percent Charge')</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
