...
@section('panel')
    ...
    <div class="row mb-none-30">
            ...
            <div class="dashboard-w1 bg--primary b-radius--10 box-shadow">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span class="text--small">@lang('Total Customer')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--cyan b-radius--10 box-shadow">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span class="text--small">@lang('Total Active Customers')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--orange b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['all_orders']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('All Orders')</span>
                    </div>

                    <a href="{{route('admin.order.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['delivered_orders']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Delivered Order')</span>
                    </div>
    ...
    <div class="row mt-50 mb-none-30">
        <div class="col-xl-6 mb-30">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">@lang('Monthly Sells & Withdraw Report')</h5>
    ...
    <div class="row mt-50 mb-none-30">
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$general->cur_sym}}{{getAmount($widget['total_deposit_amount'])}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Sell Amount')</span>
                    </div>
                    <a href="{{route('admin.deposit.list')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--3 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['total_seller']}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Seller')</span>
                    </div>
                    <a href="{{route('admin.sellers.all')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--12 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['total_active_seller']}}</span>
                        <span class="currency-sign">{{__($general->cur_text)}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Active Seller')</span>
                    </div>

                    <a href="{{route('admin.sellers.active')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--6 b-radius--10 box-shadow">
                ...
                <div class="details">
                    ...
                    <a href="{{route('admin.products.all')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
    </div>
...
@push('script')
    ...
    <script src="{{asset('assets/dashboard/js/vendor/chart.js.2.8.0.js')}}"></script>
