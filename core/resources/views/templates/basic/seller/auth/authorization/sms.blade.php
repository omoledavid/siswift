    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                ...
                <form action="{{route('seller.verify.sms')}}" method="POST" class="contact-form mb-30-none">
                    @csrf
                    ...
                    <div class="form-group">
                        <p>@lang('If you don\'t get any code'), <a href="{{route('seller.send.verify.code')}}?type=phone" class="forget-pass"> @lang('Try again')</a></p>
                    </div>
                </form>
            </div>
        </div>
