                               ...
                               <tr>
                                   ...
                                   <td data-label="@lang('Action')">
                                    ...
                                    @if($attr[0]->productAttribute->type == 2 || $attr[0]->productAttribute->type == 3)
                                        <a href="{{ route('seller.products.add-variant-images', $item->id) }}" data-toggle="tooltip" data-title="@lang('Add Variant Images')"  class="icon-btn btn--info"> <i class="la la-image"></i></a>
                                    @endif
                                       ...
                                       <a href="javascript:void(0)" class="icon-btn btn--danger deleteBtn ml-1" data-toggle="tooltip" data-title="@lang('Delete')"  data-link="{{route('seller.products.variant.delete', $item->id)}}"><i class="la la-trash"></i></a>
                                        </div>
                                   </td>
                               </tr>
                               @endforeach
...
@if(! request()->session()->has('label') && request()->session()->get('label') != 'new')
    @push('breadcrumb-plugins')
        <a href="{{ route('seller.products.all') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="las la-backward"></i>@lang('Go Back')</a>
    @endpush
@endif
        ...
        $('.editBtn').on('click', function(){
            ...
            if(item.product_attribute.type == 1){
                content = `<div class="form-group">
                                ...
                                <input type="text" placeholder="@lang('Type Here')..." class="form-control" name="name"  />
                            </div>

                            <div class="form-group">
                                <label>@lang('Value')</label>
                                <input type="text" placeholder="@lang('Type Here')..." class="form-control" name="value"  />
                            </div>

                            <div class="form-group">
                                <label>@lang('Price')</label>
                                <input type="text" class="form-control mr-xl-2 numeric-validation" name="price" value="0" placeholder="@lang('Type Here')..."  />
                            </div>
                        `;
                ...
                content = `
                            <div class="form-group"><label>@lang('Name')</label>
                                <input type="text" class="form-control" name="name" placeholder="@lang('Type Here')..."  />
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control colorCode" name="value" value="" />
                            </div>
                            <div class="form-group">
                                <label>@lang('Price')</label>
                                <input type="text" class="form-control mr-xl-2 numeric-validation" name="price" value ="0" placeholder="@lang('Type Here')..."  />
                ...
                content = `
                            ...
                            <div class="form-group">
                                <label>@lang('Price')</label>
                                <input type="text" class="form-control numeric-validation" name="price" value ="0" placeholder="@lang('Type Here')..."  />
                            </div>
                        `;
                modal.find('.modal-body').html(content);
                modal.find('input[name=name]').val(item.name);
            ...
            form.action = `{{ route('seller.products.variant.update','') }}/${item.id}`;
            modal.modal('show');
        });
    })(jQuery);
        ...
        return `
                    <div class="row single-attr">
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label>@lang('Name')</label>
                                <input type="text" placeholder="@lang('Type Here')..." class="form-control" name="text[${itr}][name]"  />
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label>@lang('Value')</label>
                                <input type="text" placeholder="@lang('Type Here')..." class="form-control" name="text[${itr}][value]"  />
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="form-group abs-form-group d-flex justify-content-between flex-wrap">
                                <input type="text" class="form-control mr-xl-2 numeric-validation" name="text[${itr}][price]" value ="0" placeholder="@lang('Type Here')..."  />
    ...
    function colorContent(){
        return `
                <div class="row single-attr">
                    <div class="col-xl-4">
                        <div class="form-group"><label>@lang('Name')</label>
                            <input type="text" class="form-control" name="color[${itr}][name]" placeholder="@lang('Type Here')..."  />
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <label>@lang('Color')</label>
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control colorCode" name="color[${itr}][value]" value="e81f1f" />
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <label>@lang('Price')</label>
                        <div class="form-group abs-form-group d-flex justify-content-between flex-wrap">
                            <input type="text" class="form-control mr-xl-2 numeric-validation" name="color[${itr}][price]" value ="0" placeholder="@lang('Type Here')..."  />
                            <button type="button" class="btn btn-outline--danger removeBtn abs-button"><i class="la la-minus"></i></button>
                        </div>
                    </div>
                </div>
        ...
        return `
            <div class="row single-attr">
                <div class="col-xl-4">
                    <div class="form-group">
                        <label>@lang('Name')</label>
                        <input type="text" class="form-control" name="img[${itr}][name]" placeholder="@lang('Type Here')..."  />
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="form-group">
                        ...
                        <div class="file-upload-wrapper" data-text="Select your file!">
                            <input type="file" name="img[${itr}][value]" class="file-upload-field" accept=".png, .jpg, .jpeg" />
                        </div>
                    </div>
                </div>
                <div class="col-xl-4">
                    <label>@lang('Price')</label>
                    <div class="form-group abs-form-group d-flex justify-content-between flex-wrap">
                        <input type="text" class="form-control mr-xl-2 numeric-validation" name="img[${itr}][price]" value ="0" placeholder="@lang('Type Here')..."  />
                        <button type="button" class="btn btn-outline--danger removeBtn abs-button"><i class="la la-minus"></i></button>
                    </div>
                </div>
            </div>
