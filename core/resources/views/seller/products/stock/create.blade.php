                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{route('seller.products.stock.log', $item['stock_id']??0)}}" class="icon-btn btn--info" data-toggle="tooltip" data-title="@lang('See Logs')"><i class="fas fa-list"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                            ...
                            <table class="table table--light">
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Quantity')">
                                        ...
                                        {{ sprintf('%02d', \App\Models\ProductStock::showAvailableStock($product->id, $attr_val=null))}}
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{route('seller.products.stock.log', $product->stocks[0]??0)}}" class="icon-btn btn--info" data-toggle="tooltip" data-title="@lang('See Logs')"><i class="fas fa-list"></i></a>
                                    </td>
                                </tr>
                            </table>
                        </div>
